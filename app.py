...
def make_proposal_pdf_bytes(section: str, data: dict, settings: dict, signer: dict, validity_days: int = 15) -> bytes:
    """
    Cloud-safe PDF generator (ReportLab). Works on Streamlit Cloud.
    """
    buffer = BytesIO()
    ...
    line("https://theadbookoutdoor.com/", 10, False, 14)
    ...
    # Signature (text-only; image signatures can be added later safely)
    ...
    c.drawString(left, 30, "This proposal is system-generated by AIAMS v8.1 (Cloud-safe PDF).")
